...
function draw_game()
	...
	local exframes = {64, 64, 66, 68, 70, 72, 72}
	for explosion in all(explosions) do
		local my_spr = explosion.age
		my_spr = flr(my_spr)
		my_spr = exframes[my_spr]
		spr(my_spr,explosion.x - 4,explosion.y - 4,2,2)
		explosion.age += 1
		for i=1,5 do
